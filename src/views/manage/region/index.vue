<template>
  <div class="app-container">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" @click="getRegionInfo(scope.row)"
            v-hasPermi="['manage:region:list']">查看详情</el-button>
    ...
    <!-- 区域详情对话框 -->
    <el-dialog title="区域详情" v-model="regionInfoOpen" width="600px">
      <el-form-item label="区域名称" prop="regionName">
        <el-input v-model="form.regionName" placeholder="请输入区域名称" disabled />
      </el-form-item>
      <el-form-item label="包含点位:"></el-form-item>
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除名称为"' + row.regionName + '"的区域？').then(function () {
